...
//  		p.sendMessage("");
  	...
  	if (cmd.getName().equalsIgnoreCase("username")){
	    ...
	    p.sendMessage(gold + "[ArcaneSurvival] " + gray + p.getDisplayName() + white + " is your username.");
...
if (cmd.getName().equalsIgnoreCase("apply")){
		...
		p.sendMessage("");
		p.sendMessage(white + "         http://www.arcane-minecraft.com/apply");
		p.sendMessage("");
...
if (cmd.getName().equalsIgnoreCase("one") || cmd.getName().equalsIgnoreCase("one")) {
 ...
 ArrayList<String> comList = new ArrayList<String>();
	...
	if (cmd.getName().equalsIgnoreCase("list")){
		...
		StringBuilder players = new StringBuilder();
					         ...
					         sender.sendMessage(gold + " Online players: " + ChatColor.RESET + Bukkit.getServer().getOnlinePlayers().length + "/" + Bukkit.getMaxPlayers());
...
//		}
		...
		//fake unknown command msg - however, any other /help <invalid> would simply return nothing
